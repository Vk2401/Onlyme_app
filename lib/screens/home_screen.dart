  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        AppHeader(
          theme: theme,
          greeting: const Greeting(sub: 'Good morning,', title: 'Vasanth 👋'),
          right: [
            HeaderBtn(theme: theme, icon: LucideIcons.search),
            HeaderBtn(theme: theme, icon: LucideIcons.bell, badge: true),
          ],
        ),
        ...
        Padding(
          ...
          child: Row(children: [
            Expanded(child: _StatCard(
              title: 'Owed to me',
              value: '₹${(owedMe/1000).toStringAsFixed(1)}k',
            ...
            Expanded(child: _StatCard(
              title: 'I owe',
              value: '₹${(iOwe/1000).toStringAsFixed(1)}k',
        ...
        const SizedBox(height: 12),
        for (final t in pending.take(3)) Padding(
              ...
              Expanded(child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: 6),
                    const Text('42-day skincare streak', style: TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.w500)),
                  ]),
                ],
              )),
              Ring(
                ...
                child: Text('${(pct * 100).round()}%', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
              ),
            ],
          ),
        ]),
